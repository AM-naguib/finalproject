        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            ...
            <li class="nav-item"><a href="https://demo.themesberg.com/volt-pro/index.html"
                    class="nav-link d-flex align-items-center"><span class="sidebar-icon"><img
                            ...
                            width="20" alt="Volt Logo"> </span><span class="mt-1 sidebar-text">Volt
                        Overview</span></a>
            </li>
            {{-- Dashboard --}}
            <li class="nav-item">
                ...
                <div class="multi-level collapse @yield('dashboard')" role="list" id="submenu-dashboard"
                    aria-expanded="false">
                    <ul class="flex-column nav">
                        ...
                        <li class="nav-item"><a href="traffic-sources.html" class="nav-link"><span
                                    class="sidebar-text-contracted">T</span> <span class="sidebar-text">All
                                    Traffic</span></a>
                        </li>
                ...
                <div class="multi-level collapse @yield('posts')" role="list" id="posts-app"
                    ...
                    <ul class="flex-column nav">
                        <li class="nav-item"><a class="nav-link" href="{{ route('admin.posts.pages-add-post') }}">
                                <span class="sidebar-text">Post in Pages</span></a></li>
            ...
            <li class="nav-item">
                <a href="../messages.html" class="nav-link d-flex align-items-center justify-content-between">
                    <span>
                        <span class="sidebar-icon">
                            <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="nav-item">
                <a href="https://themesberg.com/docs/volt-bootstrap-5-dashboard/getting-started/quick-start/"
                    ...
                    <span class="sidebar-text">Documentation <span
                            class="badge bg-secondary ms-1 text-gray-800 badge-sm">v1.4</span></span>
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item"><a href="https://themesberg.com/" target="_blank"
                    class="nav-link d-flex align-items-center"><span class="sidebar-icon"><img
                            src="https://demo.themesberg.com/volt-pro/assets/img/themesberg.svg" height="20"
                            width="28" alt="Themesberg Logo"> </span><span
                        class="sidebar-text">Themesberg</span></a></li>
        </ul>
    </div>
</nav>
